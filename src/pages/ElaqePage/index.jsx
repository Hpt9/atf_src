...
const ElaqePage = () => {
  ...
  const [contactInfo, setContactInfo] = useState({ tel: '', mail: '', address: '' });

  useEffect(() => {
    let isMounted = true;
    axios
      .get('https://atfplatform.tw1.ru/api/contact-settings')
      .then((res) => {
        ...
        <div className="grid md:grid-cols-2 gap-8 bg-[transparent] md:bg-[#FAFAFA] p-0 md:p-[64px] rounded-[24px]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {/* Email */}
              <a href={`mailto:${contactInfo.mail}`} className="flex items-center space-x-4 p-4 border border-[#E7E7E7] rounded-lg cursor-pointer hover:border-[#2E92A0] transition-colors group">
                ...
                <div>
                  ...
                  <p className="text-[#2E92A0]">{contactInfo.mail || 'info@atf.org.az'}</p>
                </div>
              ...
              {/* Phone */}
              <a href={`tel:${contactInfo.tel}`} className="flex items-center space-x-4 p-4 border border-[#E7E7E7] rounded-lg cursor-pointer hover:border-[#2E92A0] transition-colors group">
                <div className="text-[#2E92A0]">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <p className="text-[#2E92A0]">{contactInfo.tel || '(+994) 55 276 47 46'}</p>
                </div>
                <div className="ml-auto rotate-[-45deg] group-hover:rotate-0 transition-transform duration-200">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="#2E92A0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              ...
              {/* Address */}
              <a href='https://maps.app.goo.gl/UyBAArHeJUJ7qtss8' target="_blank" className="flex items-center space-x-4 p-4 border border-[#E7E7E7] rounded-lg cursor-pointer hover:border-[#2E92A0] transition-colors group">
                <div className="text-[#2E92A0]">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                  ...
                  <p className="text-[#2E92A0]">{contactInfo.address || 'Azərbaycan, Bakı şəh. Zaur Nudirəliyev küç. 79'}</p>
                </div>
                <div className="ml-auto rotate-[-45deg] group-hover:rotate-0 transition-transform duration-200">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="#2E92A0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
